...
- Report METABRIC external validation metrics.
...
def main():
    ...
    print("\nPredicting METABRIC external validation set...")
    ...
    metabric_metrics = make_metrics(y_metabric, metabric_pred, "metabric_external_validation")
    ...
    print("\nMETABRIC external validation classification report:")
    ...
    metabric_cm = save_confusion_matrix(
        ...
        metabric_pred,
        class_names,
        OUTPUT_DIR / "metabric_external_logistic_regression_confusion_matrix.csv",
    )

    print("\nTCGA overlap-gene confusion matrix:")
    print(tcga_cm)

    print("\nMETABRIC external validation confusion matrix:")
    print(metabric_cm)

    metrics_file = OUTPUT_DIR / "metabric_external_validation_metrics.csv"
    tcga_pred_file = OUTPUT_DIR / "tcga_test_overlap_logistic_regression_predictions.csv"
    metabric_pred_file = OUTPUT_DIR / "metabric_external_logistic_regression_predictions.csv"
    ...
    print("\n✅ METABRIC external validation completed successfully.")
